...
namespace TheDocsNetCore.Data.Migrations
{
    ...
    [Migration("20160628190149_AddNameFieldsToUsers")]
    partial class AddNameFieldsToUsers
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("TheDocsNetCore.Data.Comment", b =>
                {
            ...
            modelBuilder.Entity("TheDocsNetCore.Data.Post", b =>
                {
                    b.Property<int>("PostID")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("TheDocsNetCore.Data.Comment", b =>
                {
                    ...
                    b.HasOne("TheDocsNetCore.Data.Post", "Post")
                        .WithMany("Comments")
